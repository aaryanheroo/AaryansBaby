...
<body class="gradient-background">
  <div class="flex items-center justify-center h-screen">
    <div class="flex flex-col items-center p-4">
      ...
      <h2 id="valentineQuestion" class="text-4xl font-bold italic text-[#bd1e59] my-4">Will you be my Valentine Sunshine?</h2>
  ...
  <script type="module">
    ...
    noButton.addEventListener('click', function() {
      if (noClickCount < 5) {
        ...
        if (noClickCount < 6) {
          noButton.textContent = ["No Baby", "Are you sure?", "Mutu please", "Are you really doing this to me :(", "You're breaking my heart", "I'm gonna cry now..."][noClickCount];
        }
      }
    });
